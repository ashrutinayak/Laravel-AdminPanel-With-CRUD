			...
			<section class="card">
				<div class="card-block">
					<div class="row m-t-lg">
						<div class="col-md-12">
							<form id="form-signup_v1" name="frmstf_add" method="post" action="{{ route('updatecategory') }}">
                            @csrf    
                            <div class="form-group">
                                    ...
                                    <input type="text" name="cat_id" placeholder="Enter First Name" id="txtfname" value="{{ $cat->id }}" hidden="hidden" />
										<input id="categoryname" class="form-control" name="categoryname" type="text" value="{{ $cat->name }}">
									</div>
								</div>
                                								
								<div class="form-group">
									<button type="submit" class="btn" onclick="return validation();">Update Category</button>
								</div>
							</form>
						</div>
